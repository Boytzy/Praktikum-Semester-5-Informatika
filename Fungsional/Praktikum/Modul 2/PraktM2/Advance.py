...
move_bidak = lambda x, y, direction: (x + direction[0], y + direction[1])

def main():
    while True:
        
        width = int(input("Masukkan ukuran board: "))
        ...
        while not is_game_over(bidak, goals):
            ...
            print_board(board)
            navigasi = input("Masukkan navigasi (contoh: WWAASSDD): ").upper()
